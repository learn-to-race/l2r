...
class MockROS2Middleware(L2RMiddleware, Node):
    def __init__(self):
        ...
        self.l2r_cam_connection = connection.L2RCamConnection()
        self.l2r_action_connection = connection.L2RActionConnection()
        self.target_pose_connection = connection.ROS2SubConnection(
            "pose_sub", "pose", ByteMultiArray
        )
        self.target_cam_connection = connection.ROS2SubConnection(
            "image_sub", "image", ByteMultiArray
        )
        self.target_action_connection = connection.ROS2PubConnection(
            "action_pub", "action", ByteMultiArray
        )
